...
let config = _production.default; // The check is on location.href, in this case detect if is localhost
...
var _default = config;
exports.default = _default;
},{"./develop":"../client/config/develop.js","./production":"../client/config/production.js"}],"../image/logo.png":[function(require,module,exports) {
module.exports = "/logo.30361df5.png";
},{}],"../node_modules/doz-router/dist/bundle.js":[function(require,module,exports) {
var define;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../client/app.css":[function(require,module,exports) {
...
module.exports = {
  ...
  "imgMove": "app_imgMove_3ujr7"
};
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../client/cmp/nav.js":[function(require,module,exports) {
"use strict";
  ...
  return h`
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a data-router-link href="/catalogo">Catalogo</a>
                </li>
                <li>
                    <a data-router-link href="/about">About</a>
                </li>
                <li>
                    <a data-router-link href="/contatti">Contatti</a>
                </li>
            </ul>   
        </nav>
    `;
}
},{}],"../client/cmp/pages/home.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"doz":"../node_modules/doz/dist/doz.js"}],"../client/cmp/pages/about.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"doz":"../node_modules/doz/dist/doz.js"}],"../client/cmp/pages/contatti.js":[function(require,module,exports) {
"use strict";
...
var _logo = _interopRequireDefault(require("../image/logo.png"));

var _dozRouter = _interopRequireDefault(require("doz-router"));

require("./app.css");

var _nav = _interopRequireDefault(require("./cmp/nav"));

var _home = _interopRequireDefault(require("./cmp/pages/home"));

var _about = _interopRequireDefault(require("./cmp/pages/about"));

var _contatti = _interopRequireDefault(require("./cmp/pages/contatti"));

var _catalogo = _interopRequireDefault(require("./cmp/pages/catalogo"));
...
new _doz.default({
  ...
  template(h) {
    return h`
            ...
            <main>
                <${_dozRouter.default} mode="history">
                    <${_home.default} route="/"/>
                    <${_catalogo.default} route="/catalogo"/>
                    <${_about.default} route="/about"/>
                    <${_contatti.default} route="/contatti"/>
                </${_dozRouter.default}>
            </main>
        `;
  },
...
},{"doz":"../node_modules/doz/dist/doz.js","doz-hot-location-reload":"../node_modules/doz-hot-location-reload/index.js","doz-metatag":"../node_modules/doz-metatag/index.js","doz-ssr/plugin":"../node_modules/doz-ssr/plugin.js","./config":"../client/config/index.js","../image/logo.png":"../image/logo.png","doz-router":"../node_modules/doz-router/dist/bundle.js","./app.css":"../client/app.css","./cmp/nav":"../client/cmp/nav.js","./cmp/pages/home":"../client/cmp/pages/home.js","./cmp/pages/about":"../client/cmp/pages/about.js","./cmp/pages/contatti":"../client/cmp/pages/contatti.js","./cmp/pages/catalogo":"../client/cmp/pages/catalogo.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
